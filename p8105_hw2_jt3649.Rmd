...
The `snp` dataset contained information about the Standard & Poor’s stock market index (S&P) from `r min(snp_df$year)` to `r max(snp_df$year)`. It included `r nrow(snp_df)` observations of the closing value of the S&P index, and it serves as a representative measure of stock market performance.
