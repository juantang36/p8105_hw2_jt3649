...
The final tidy dataset contains `r format(n_observations)` observations representing monthly rental price data for `r n_unique_zips` unique ZIP codes across `r n_unique_neighborhoods` neighborhoods in New York City. 
