...
```
    ...
    ##  1 April     1950  18.0
    ##  2 August    1950  18.4
    ##  3 December  1950  20.4
    ##  4 February  1950  17.2
    ##  5 January   1950  17.0
    ##  6 July      1950  17.8
    ##  7 June      1950  17.7
    ##  8 March     1950  17.3
    ##  9 May       1950  18.8
    ## 10 November  1950  19.5
    ## # ℹ 777 more rows
...
This dataset contains information about trash collected by three
water-wheel vessels that remove trash from the Inner Harbor in
Baltimore, Maryland. The combined dataset has 1188 observations and 15
variables. The dataset includes data from 2014 to 2025. Variables
include specific type of trash, date, total weight of trash, and
dumpster, which is the identifier for each dumpster load. Variables in
the merged dataset are: dumpster, month, year, date, weight_tons,
